...
class SavePlotsConfiguration(AbstractCommand):
    def __init__(self, DTVlist, frame, nodeData=None, cols=None):
    ...
    def execute(self):
        ...
        for dtv in self.DTVlist:
            ...
            selectedsignalsList = GlobalOperations.getSortedSelectedSignals(dtv.selectedSignals)
        ...
        #self.f.close()
        for dtv in self.DTVlist:
            if dtv.parent.configurationListsFrame != None:
                dtv.parent.configurationListsFrame.update()
