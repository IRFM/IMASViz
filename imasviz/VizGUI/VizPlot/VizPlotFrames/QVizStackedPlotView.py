...
class QVizStackedPlotView(QtWidgets.QMainWindow):
    """Main StackedPlotView window for plotting the selected signals.
    """
    ...
    def __init__(self, dataTreeView, figureKey=0, update=0,
        ...
        """
        super(QVizStackedPlotView, self).__init__(parent=dataTreeView)

        # TODO: Both TablePlotView and StackedPlotView constructor use QMainWindow and
    ...
    def getNumSignals(self, all_DTV = True):
        """Get number of signals intended for the StackedPlotView feature
...
class QVizStackedPlotViewGraphicsWindow(GraphicsWindow):
    """GraphicsWindow containing the StackedPlotView plots.
    """

    def __init__(self, parent, ncols=3):
        """
        Arguments:
            parent (QtWidgets.QMainWindow) : Parent of StackedPlotView GraphicsWindow.
            ncols  (int)         : Number of columns.
        """

        super(QVizStackedPlotViewGraphicsWindow, self).__init__(parent=parent)
        # super(QVizStackedPlotViewGraphicsWindow, self).__init__()
    ...
    def plot(self, n, x, y, label, xlabel, ylabel, title):
        """Add new plot to StackedPlotView GraphicsWindow.
