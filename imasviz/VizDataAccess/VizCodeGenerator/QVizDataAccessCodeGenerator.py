    ...
    def generateCode(self, XMLtreeIDSDef, className):
        ...
        for ids in root:
            ...
            if i == 0:
                ...
                self.printCode('from PySide2.QtCore import QThread', -1)
                self.printCode('from PySide2.QtWidgets import QApplication, QInputDialog', -1)
                ...
                self.printCode(
                    "def __init__(self, userName, imasDbName, shotNumber, runNumber, view, IDSName, occurrence=0, viewLoadingStrategy=None, asynch=True):",
                    0)
                ...
                for ids2 in root:
                    ...
                    self.printCode("self.ids." + name_att2 + ".get(self.occurrence)",
                                   4)  # get the data from the database for the ids"
                ...
                self.printCode(
                    'logging.error("An attribute error has occurred. This means that IMASViz is using a wrong data parser ' +
