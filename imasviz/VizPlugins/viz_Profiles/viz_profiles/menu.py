...
from PyQt5.QtWidgets import QProgressBar, QVBoxLayout, QDesktopWidget, QWidget
...
class Worker(QObject):
    finished = pyqtSignal()
    call = pyqtSignal()
    progressBar = pyqtSignal(int, str)
...
if __name__ == "__main__":
    ...
    handler = QVizLogger.getHandler(use_rich_text=False)
    ...
    handler.new_record.connect(mw.statusbar.showMessage)
